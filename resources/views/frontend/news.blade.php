                ...
                <div class="col-md-8">
                    <div class="blog_page_search">
                        <form action="{{ route('news') }}" method="GET">
                            <div class="row">
                                <div class="col-lg-5">
                                    <input type="text" value="{{ request()->search }}" name="search" placeholder="{{ __('frontend.Type here') }}" />
                                </div>
                                <div class="col-lg-4">
                                        ...
                                        <div class="article__content">
                                            ...
                                            <ul class="list-inline">
                                                <li class="list-inline-item">
                                                    <span class="text-primary"> {{ __('frontend.by') }} {{ $data->author->name }} </span>
                                                </li>
                                                <li class="list-inline-item">
                                            ...
                                            <a href="{{ route('news.details', $data->slug) }}" class="btn btn-outline-primary mb-4 text-capitalize"> {{ __('frontend.read more') }}</a>
                                        </div>
                                    </div>
                                </div>
                            @empty
                                <div class="text-center w-100">
                                    <p>{{ __('frontend.No news found.') }}</p>
                                </div>
                            @endforelse
                        </div>
                        <!-- Pagination -->
